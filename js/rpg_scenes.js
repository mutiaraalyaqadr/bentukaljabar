...
Scene_Title.prototype.createCommandWindow = function() {
    ...
    this._commandWindow.setHandler('keyboardGuide', this.commandKeyboardGuide.bind(this));
...
Scene_Title.prototype.commandKeyboardGuide = function() {
    SceneManager.push(Scene_KeyboardGuide);
};

function Scene_KeyboardGuide() {
    this.initialize.apply(this, arguments);
}

Scene_KeyboardGuide.prototype = Object.create(Scene_Base.prototype);
Scene_KeyboardGuide.prototype.constructor = Scene_KeyboardGuide;

Scene_KeyboardGuide.prototype.initialize = function() {
    Scene_Base.prototype.initialize.call(this);
};

Scene_KeyboardGuide.prototype.create = function() {
    Scene_Base.prototype.create.call(this);
    this.createBackground();
};

Scene_KeyboardGuide.prototype.createBackground = function() {
    this._backgroundSprite = new Sprite();
    this._backgroundSprite.bitmap = ImageManager.loadPicture("keyboard guide"); // Nama file gambar
    this.addChild(this._backgroundSprite);
};

Scene_KeyboardGuide.prototype.update = function() {
    Scene_Base.prototype.update.call(this);
